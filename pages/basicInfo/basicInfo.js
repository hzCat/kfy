...
Page({
  ...
  bindHeightChange: function(e) {
    ...
    // 屏蔽未修改
    if (
      this.data.allInfo.vipUserInfo.height !=
      parseInt(that.data.userHeight[this.data.hIndex])
    ) {
      var obj = that.data.pushInfo;
  ...
  bindWeightChange: function(e) {
    ...
    // 屏蔽未修改
    if (
      this.data.allInfo.vipUserInfo.weight !=
      parseInt(that.data.userWeight[this.data.kgIndex])
    ) {
      var obj = that.data.pushInfo;
  ...
  bindBirthChange: function(e) {
    ...
    // 超过现在时间屏蔽
    if (
      e.detail.value.replace(/-/g, "") <= that.data.nowdays.replace(/-/g, "")
    ) {
      that.setData({
      ...
      // 屏蔽未修改
      if (
        this.data.allInfo.vipUserInfo.birthday !=
  ...
  submitClick() {
    ...
    if (
      (this.data.nickName ||
        ...
        this.data.allInfo.nickName) &&
      (this.data.yourName || this.data.allInfo.realName) &&
      (this.data.userSex[this.data.sIndex || this.data.userInfo.gender] ||
        this.data.allInfo.vipUserInfo.sex) &&
